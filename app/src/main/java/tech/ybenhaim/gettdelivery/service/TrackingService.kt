...
import tech.ybenhaim.gettdelivery.util.Constants.ACTION_PAUSE_SERVICE
import tech.ybenhaim.gettdelivery.util.Constants.ACTION_SHOW_MAIN_ACTIVITY
import tech.ybenhaim.gettdelivery.util.Constants.ACTION_START_OR_RESUME_SERVICE
import tech.ybenhaim.gettdelivery.util.Constants.ACTION_STOP_SERVICE
import tech.ybenhaim.gettdelivery.util.Constants.FASTEST_LOCATION_INTERVAL
import tech.ybenhaim.gettdelivery.util.Constants.LOCATION_UPDATE_INTERVAL
import tech.ybenhaim.gettdelivery.util.Constants.NOTIFICATION_CHANNEL_ID
import tech.ybenhaim.gettdelivery.util.Constants.NOTIFICATION_CHANNEL_NAME
import tech.ybenhaim.gettdelivery.util.Constants.NOTIFICATION_ID
